...
// Source: ./src/sanity/lib/orders/getUserOrders.ts
// Variable: getUserOrdersQuery
// Query: *[_type == "order" && clerkUserId == $userId] {            ...,            products[]{                ...,                product->            }        }
export type GetUserOrdersQueryResult = Array<{
  _id: string;
  _type: "order";
  _createdAt: string;
  _updatedAt: string;
...
export type ProductNameQueryResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: activeSaleByCouponCodeQuery
// Query: *[_type == "sale" && isActive == true && couponCode == $couponCode] | order(validFrom desc)[0]
export type ActiveSaleByCouponCodeQueryResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
